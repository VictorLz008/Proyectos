<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormPeriodos.aspx.cs" Inherits="WebHorarios.WebFormPeriodos" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <!--Insertar-->
            <asp:Label ID="Label1" runat="server" Text="Nombre del Periodo: "></asp:Label>
            ...
            <asp:Label ID="Label4" runat="server" Text="Año del Periodo: "></asp:Label>
            ...
            <asp:Label ID="Label5" runat="server" Text="Nombre del Periodo: "></asp:Label>
            <asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
            <asp:Label ID="Label6" runat="server" Text="Fecha de Inicio: "></asp:Label>
            <asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>
            <asp:Label ID="Label7" runat="server" Text="Fecha de Finalización: "></asp:Label>
            <asp:TextBox ID="TextBox8" runat="server"></asp:TextBox>
            <asp:Label ID="Label8" runat="server" Text="Año del Periodo: "></asp:Label>
